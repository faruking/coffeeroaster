    ...
    return (
        <footer>
            ...
            <nav className='nav-flex'>
                <ul>
                    <li onClick={function () { window.location.href = 'https://www.github.com/faruking' }} className="icon-facebook"></li>
                    <li onClick={function () { window.location.href = 'https://www.twitter.com/faruking2' }} className="icon-twitter"></li>
                    <li onClick={function () { window.location.href = 'https://www.linkedin.com/in/faabtech' }} className="icon-instagram"></li>
                </ul>
            </nav>
        </footer>
    )
